...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  const filteredNavItems = navItems.filter(item => {
    if (userRole === 'super_admin') {
      ...
      return ['/dashboard', '/staff-management', '/my-lessons', '/progress', "/menu-management", "/previous-menu", "/lesson-progress", "/restaurant-management"].includes(item.href);
    } else if (userRole === 'director') {
      return ['/dashboard', '/staff-management', '/restaurant-management', '/menu-management', "/previous-menu", "/lesson-progress", '/my-lessons', '/progress'].includes(item.href);
